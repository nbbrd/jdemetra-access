...
public abstract class DbAccessorTest<BEAN extends DbBean> {
    ...
    @Test
    public void testGetChildren_Val0Dim0() {
        Assertions.assertThatIllegalArgumentException()
                .isThrownBy(() -> A0.getChildren());
    }
    ...
    @Test
    public void testGetChildren_Val2Dim2() {
        Assertions.assertThatIllegalArgumentException()
                .isThrownBy(() -> A2.getChildren(Top5Table.DIM0[0], Top5Table.DIM1[0]));
    }

    @Test
    public void testGetAllSeries_Val0Dim0() {
        Assertions.assertThatIllegalArgumentException()
                .isThrownBy(() -> A0.getAllSeries());
    }
    ...
    @Test
    public void testGetAllSeries_Val2Dim2() {
        Assertions.assertThatIllegalArgumentException()
                .isThrownBy(() -> A2.getAllSeries(Top5Table.DIM0[0], Top5Table.DIM1[0]));
    }

    @Test
    public void testGetAllSeriesWithData_Val0Dim0() {
        Assertions.assertThatIllegalArgumentException()
                .isThrownBy(() -> A0.getAllSeriesWithData());
    }
    ...
    public void testGetAllSeriesWithData_Val2Dim2() throws Exception {
        Assertions.assertThatIllegalArgumentException()
                .isThrownBy(() -> A2.getAllSeriesWithData(Top5Table.DIM0[0], Top5Table.DIM0[1]));
    }
    ...
    @Test
    public void testSeriesWithData_Val0Dim2() {
        Assertions.assertThatIllegalArgumentException()
                .isThrownBy(() -> A2.getSeriesWithData());
    }

    @Test
    public void testSeriesWithData_Val1Dim2() {
        Assertions.assertThatIllegalArgumentException()
                .isThrownBy(() -> A2.getSeriesWithData(Top5Table.DIM0[0]));
    }
